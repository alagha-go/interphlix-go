...
func GetUserInfo(token string) (accounts.Account, error) {
	...
	return accounts.Account{Email: account.Email, EmailVerified: account.EmailVerified, UserName: account.Name, GivenName: account.GivenName, FamilyName: account.FamilyName, Photo: account.Picture}, nil
}
